...
| key | category | status | source | flow/gate | text / variants | notes |
| --- | --- | --- | --- | --- | --- | --- |
| sandbox.debug.warmup_reply | debug_text | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.debug.warmup_reply"] | WAIT_WARMUP_REPLY | 暖場測試回覆 | Debug smoke-test text for sandbox warmup reply simulation. |
| sandbox.glitch.answer_eval.1 | sandbox_glitch | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.glitch.answer_eval.1"] | ANSWER_EVAL | 我這邊送出一直失敗 | Glitch burst line emitted by viewer_118 during ANSWER_EVAL. |
| sandbox.glitch.answer_eval.2 | sandbox_glitch | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.glitch.answer_eval.2"] | ANSWER_EVAL | 聊天室是不是延遲了 | Glitch burst line emitted by viewer_203 during ANSWER_EVAL. |
| sandbox.glitch.answer_eval.3 | sandbox_glitch | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.glitch.answer_eval.3"] | ANSWER_EVAL | 網路怪怪的，剛剛卡一下 | Glitch burst line emitted by viewer_409 during ANSWER_EVAL. |
| sandbox.hint.help_fallback | sandbox_help_hint | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.hint.help_fallback"] | consonant_answer | 先想一下圖像記憶那個關鍵字。 | Fallback help hint when shared memory hint is unavailable. |
| sandbox.hint.help_memory | sandbox_help_hint | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.hint.help_memory"] | consonant_answer | 想一下{imageMemoryHint}那個。 | Help hint template using shared image-memory hint token. |
| sandbox.preheat.1 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.1"] | PREHEAT_CHAT | 今天怎麼這麼多人一起在線？ | Preheat ambient chat line owned by editable content layer. |
| sandbox.preheat.2 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.2"] | PREHEAT_CHAT | viewer_721 加入聊天室 | Preheat system join line owned by editable content layer. |
| sandbox.preheat.3 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.3"] | PREHEAT_CHAT | 我有點懷疑這台是真的假的直播… | Preheat ambient chat line owned by editable content layer. |
| sandbox.preheat.4 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.4"] | PREHEAT_CHAT | 上次這間真的很多人說看到鬼影。 | Preheat ambient chat line owned by editable content layer. |
| sandbox.preheat.5 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.5"] | PREHEAT_CHAT | viewer_823 加入聊天室 | Preheat system join line owned by editable content layer. |
| sandbox.preheat.6 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.6"] | PREHEAT_CHAT | @activeUser 你是第一次看這個台嗎？ | Preheat ambient chat line owned by editable content layer. |
| sandbox.preheat.7 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.7"] | PREHEAT_CHAT | 剛剛鏡頭邊緣是不是有東西飄過去？ | Preheat ambient chat line owned by editable content layer. |
| sandbox.preheat.8 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.8"] | PREHEAT_CHAT | viewer_477 加入聊天室 | Preheat system join line owned by editable content layer. |
| sandbox.preheat.9 | sandbox_preheat | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.preheat.9"] | PREHEAT_CHAT | 先暖場聊天，等等再看後面有沒有異常。 | Preheat ambient chat line owned by editable content layer. |
| sandbox.prompt.reveal_prompt | sandbox_prompt | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.prompt.reveal_prompt"] | consonant_answer | 請讀出剛剛閃過的字：{consonant} | Prompt template shown before sandbox consonant reply gate opens. |
...
| sandbox.vip_summary.1 | sandbox_vip_summary | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.vip_summary.1"] | VIP_SUMMARY_1 | VIP 總結：先把剛剛那個單字記住，下一步確認發音。 | VIP summary line dispatched during sandbox word-reveal sequence. |
| sandbox.vip_summary.2 | sandbox_vip_summary | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["sandbox.vip_summary.2"] | VIP_SUMMARY_2 | VIP 總結：發音方向差不多了，最後確認這個詞在指誰。 | Second VIP summary line dispatched during sandbox word-reveal sequence. |
...
| ui.chat.latest.default | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.latest.default"] |  | 最新訊息 | Jump-to-latest button label. |
| ui.chat.latest.mention | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.latest.mention"] |  | @你・跳到最新 | Jump-to-latest mention button label. |
| ui.chat.pinned.highlight_only | debug_text | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.pinned.highlight_only"] |  | （highlight only：未 armed，不能正式回覆） | Debug note when pinned sandbox content is highlight-only. |
| ui.chat.pinned.missing_source | fallback | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.pinned.missing_source"] |  | （原始訊息已不存在） | Pinned preview fallback when original source message is gone. |
| ui.chat.placeholder | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.placeholder"] |  | 傳送訊息 | Chat input placeholder shown in ChatPanel. |
| ui.chat.send.initializing | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.send.initializing"] |  | 初始化中… | Chat send button label while app is booting. |
| ui.chat.send.ready | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.send.ready"] |  | 送出 | Default chat send button label. |
| ui.chat.send.sending | ui_placeholder | active | src/content/chat-content/editable/authoredChatContent.json#authoredChatContent["ui.chat.send.sending"] |  | 送出中… | Chat send button label while sending. |
