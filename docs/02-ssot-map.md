...
| Sandbox360 娃娃定位/圖層 | `src/modes/sandbox_360_test/Sandbox360Viewer.tsx`、`src/modes/sandbox_360_test/assets.ts` | `DOLL_ABSOLUTE_RECT_BASE_SCENE_PX`（base scene px SSOT）與 `#layer-open/#layer-look/#layer-closed` 資產路徑 |
