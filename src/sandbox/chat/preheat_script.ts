...
export const PREHEAT_SCRIPT: PreheatScriptEvent[] = [
  ...
  { atMs: 900, speaker: 'vip', text: '@{{PLAYER}} 嗨嗨，第一次看嗎？', poolHint: 'vip_intro' },
  { atMs: 1900, speaker: 'viewer', text: '@VIP 你又來了XD', poolHint: 'viewer_banter' },
  { atMs: 3000, speaker: 'viewer', text: 'VIP 今天這麼早報到喔', poolHint: 'viewer_banter' },
  { atMs: 4200, speaker: 'vip', text: '我看這台很久了，上次那段超扯', poolHint: 'vip_memory' },
  ...
  { atMs: 11100, speaker: 'viewer', text: '@VIP 你上次不是說真的有聽到聲音？', poolHint: 'viewer_followup' },
  { atMs: 13600, speaker: 'vip', text: '有啊，那段回放我重看三次還是毛毛的', poolHint: 'vip_followup' },
