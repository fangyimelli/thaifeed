...
export const SANDBOX360_DOLL_LAYER_ASSETS = {
  open: resolveAssetUrl('assets/sandbox360/dolls/doll_layer_open.png'),
  look: resolveAssetUrl('assets/sandbox360/dolls/doll_layer_look.png'),
  closed: resolveAssetUrl('assets/sandbox360/dolls/doll_layer_closed.png')
} as const;
