...
export default function App() {
  ...
  const roomSubtitle = useMemo(
    () => `請輸入子音「${state.targetConsonant}」 (可用 ผ / ph / ㄆ)`,
    [state.targetConsonant]
  );
  ...
  return (
    <div className="app-layout">
      <SceneView roomName={state.roomName} targetConsonant={state.targetConsonant} curse={state.curse} subtitle={roomSubtitle} />
      <ChatPanel
