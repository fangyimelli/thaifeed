...
if (/\b(setChatTickRestartKey|chatTickRestartKey)\b/.test(appSource)) {
  console.warn(`[netlify-build] Warning: legacy chatTickRestartKey token detected in ${appPath}; deferring to TypeScript compile for authoritative validation.`);
} else {
